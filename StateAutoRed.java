...
@Autonomous(name = "StateAutoRed", group = "")
...
public class StateAutoRed extends LinearOpMode {
    ...
    private int MiddleLevelLeft = -730;
    private int BottomLevelLeft = -625;
    ...
    public void runOpMode() {
        ...
        Trajectory hub = drive.trajectoryBuilder(startPose)
                .lineToLinearHeading(new Pose2d(0, -52, Math.toRadians(22)))
        ...
        Trajectory warehouse = drive.trajectoryBuilder(hub.end())
                .splineToConstantHeading(new Vector2d(9, -65), Math.toRadians(-40))
                .splineToSplineHeading(new Pose2d(15, -68, Math.toRadians(0)), Math.toRadians(0))
                .splineToSplineHeading(new Pose2d(44, -68, Math.toRadians(0)), Math.toRadians(0))
        ...
        Trajectory dropOff = drive.trajectoryBuilder(warehouse.end())
                .lineToLinearHeading(new Pose2d(36, -70, Math.toRadians(0)))
                .splineToConstantHeading(new Vector2d(16, -68), Math.toRadians(150))
             //   .splineToSplineHeading(new Pose2d(6, -54, Math.toRadians(30)), Math.toRadians(105))
                .splineToSplineHeading(new Pose2d(6, -50, Math.toRadians(30)), Math.toRadians(105))
                .addDisplacementMarker(0, () -> {
        ...
        Trajectory warehouse1 = drive.trajectoryBuilder(dropOff.end())
                ...
                .splineToSplineHeading(new Pose2d(50, -70, Math.toRadians(0)), Math.toRadians(0))
        ...
        Trajectory dropOff3 = drive.trajectoryBuilder(warehouse2.end())
                .lineToLinearHeading(new Pose2d(36, -70, Math.toRadians(0)))
                .splineToConstantHeading(new Vector2d(16, -68), Math.toRadians(145))
                .splineToSplineHeading(new Pose2d(6, -54, Math.toRadians(20)), Math.toRadians(105))
                .addDisplacementMarker(0, () -> {
                    Intake.setPower((0.4 * spitout));
                    leftSweeper.setPower(-1);
                    rightSweeper.setPower(-1);
