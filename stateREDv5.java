...
@Autonomous(name = "DELIA", group = "")

public class stateREDv5 extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        Trajectory hub = drive.trajectoryBuilder(startPose)
                .lineToLinearHeading(new Pose2d(7,-28, Math.toRadians(80)))
                .build();
        Trajectory warehouse = drive.trajectoryBuilder(hub.end())
                .splineToSplineHeading(new Pose2d(13,-64, Math.toRadians(0)), Math.toRadians(0))
                .splineToLinearHeading(new Pose2d(55,-62, Math.toRadians(0)), Math.toRadians(0))
                .build();
