...
@Autonomous(name = "stateBlue", group = "")
@Disabled
public class stateBLUE extends LinearOpMode {
    ...
    private int TopLevelRight = -890;
    private int MiddleLevelRight = -617;
    private int BottomLevelRight = -340;
...
*/
        Trajectory backtostart = drive.trajectoryBuilder(warehouse.end())
             ...
             //   .splineToSplineHeading(new Pose2d(5,-40, Math.toRadians(20)), Math.toRadians(0))
                .lineToLinearHeading(new Pose2d(10,66,Math.toRadians(0)))
            //    .splineToSplineHeading(new Pose2d(-5,-66, Math.toRadians(0)), Math.toRadians(0))
               .splineToSplineHeading(new Pose2d(3,42, Math.toRadians(-30)), Math.toRadians(-85))
  ...
  //              .lineToLinearHeading(new Pose2d(-5,-40,Math.toRadians(0)))
    //            .build();
        ...
        Trajectory backtostart2 = drive.trajectoryBuilder(backtostart.end().plus(new Pose2d(0,0,Math.toRadians(0))))
               // .lineToLinearHeading(new Pose2d(5,-66,Math.toRadians(0)))
                .splineToSplineHeading(new Pose2d(23,63, Math.toRadians(0)), Math.toRadians(0))
                .splineToSplineHeading(new Pose2d(49,68, Math.toRadians(0)), Math.toRadians(0))
        ...
        Trajectory backtostart3 = drive.trajectoryBuilder(backtostart2.end())
                ...
                .lineToLinearHeading(new Pose2d(10,66,Math.toRadians(0)))
                //    .splineToSplineHeading(new Pose2d(-5,-66, Math.toRadians(0)), Math.toRadians(0))
                .splineToSplineHeading(new Pose2d(3,40, Math.toRadians(-30)), Math.toRadians(-85))
                .addDisplacementMarker(10, ()->{
                    Arm.setTargetPosition(TopLevelRight);
                    Arm.setPower(1);
                })
        ...
        Trajectory backtostart4 = drive.trajectoryBuilder(backtostart3.end())
              //  .lineToLinearHeading(new Pose2d(5,-66,Math.toRadians(0)))
                .splineToSplineHeading(new Pose2d(23,68, Math.toRadians(0)), Math.toRadians(0))
                .splineToSplineHeading(new Pose2d(57,63, Math.toRadians(0)), Math.toRadians(0))
                .addDisplacementMarker(1, ()->{
                    extension.setTargetPosition(0);
                    extension.setPower(1);
                })
        ...
        Trajectory backtostart5 = drive.trajectoryBuilder(backtostart4.end())
               // .lineToLinearHeading(new Pose2d(10,-66,Math.toRadians(0)))
                .lineToLinearHeading(new Pose2d(10,68,Math.toRadians(0)))
                //    .splineToSplineHeading(new Pose2d(-5,-66, Math.toRadians(0)), Math.toRadians(0))
                .splineToSplineHeading(new Pose2d(0,40, Math.toRadians(-60)), Math.toRadians(-90))
                .addDisplacementMarker(10, ()->{
                    Arm.setTargetPosition(TopLevelRight);
                    Arm.setPower(1);
                })
        ...
        Trajectory backtostart6 = drive.trajectoryBuilder(backtostart5.end())
               // .lineToLinearHeading(new Pose2d(5,-66,Math.toRadians(0)))
                .splineToSplineHeading(new Pose2d(23,70, Math.toRadians(0)), Math.toRadians(0))
                .splineToSplineHeading(new Pose2d(56,63, Math.toRadians(0)), Math.toRadians(0))
