...
public class stateBLUEv2 extends LinearOpMode {
    ...
    private int BottomLevelRight = -390;
    ...
    public void runOpMode(){
        ...
        Trajectory goinwarehouse = drive.trajectoryBuilder(hub.end())
                .splineTo(new Vector2d(-10,63), Math.toRadians(0))
                .splineTo(new Vector2d(25,68), Math.toRadians(0))

                .splineTo(new Vector2d(49,68), Math.toRadians(0))
        ...
        Trajectory dropoff1 = drive.trajectoryBuilder(goinwarehouse.end())
                .lineToLinearHeading(new Pose2d(3,68,Math.toRadians(0)))
                .splineToSplineHeading(new Pose2d(5,43, Math.toRadians(-30)), Math.toRadians(-85))
        ...
        Trajectory goinwarehouse2 = drive.trajectoryBuilder(dropoff1.end().plus(new Pose2d(0,0,Math.toRadians(0))))
                .splineTo(new Vector2d(-6,63), Math.toRadians(0))
                .splineTo(new Vector2d(25,68), Math.toRadians(0))
        ...
        Trajectory dropoff2 = drive.trajectoryBuilder(goinwarehouse2.end())
                ...
                .splineToSplineHeading(new Pose2d(7,44, Math.toRadians(-30)), Math.toRadians(-85))
                .addDisplacementMarker(0, ()->{
                    extension.setTargetPosition(0);
                    extension.setPower(1);
                })
        ...
        Trajectory goinwarehouse3 = drive.trajectoryBuilder(dropoff2.end())
                .splineTo(new Vector2d(-3,63), Math.toRadians(0))
                .splineTo(new Vector2d(25,68), Math.toRadians(0))
                .splineTo(new Vector2d(57,68), Math.toRadians(0))
                .addDisplacementMarker(1, ()->{
                    extension.setTargetPosition(0);
                    extension.setPower(1);
                })
