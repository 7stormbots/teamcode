...
public class ShippingElementDetectorBlueDepotv2 extends OpenCvPipeline {
    ...
    public ShippingElementDetectorBlueDepotv2() {
...
*/
        ...
        Mat matCenter2 = workingMatrix2.submat(155, 205, 130, 180);
        Mat matRight2 = workingMatrix2.submat(40, 90, 130, 180);

        Imgproc.rectangle(workingMatrix2, new Rect(155, 180, 50, 50), new Scalar(255, 255, 255));
        Imgproc.rectangle(workingMatrix2, new Rect(155, 65, 50, 50), new Scalar(0, 0, 255));
// COLUMN = X  ROW = Y
