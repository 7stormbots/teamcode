...
@Autonomous(name = "BlueCarousel - DOES NOT STOP", group = "")
@Disabled
public class BlueCarouselv2 extends LinearOpMode {
    ...
    private ShippingElementDetectorBlueCarousel detector = new ShippingElementDetectorBlueCarousel();
    ...
    public void runOpMode(){
        ...
        Trajectory straferight = drive.trajectoryBuilder(carousel.end().plus(new Pose2d(0,0,Math.toRadians(90))))
                ...
                .strafeLeft(4)
                .build();
        Trajectory lineToLeftDrop = drive.trajectoryBuilder(carousel.end())
        ...
        Trajectory forward2 = drive.trajectoryBuilder(lineToHub2.end())
                .forward(7)
                .build();
        Trajectory BackintoHub = drive.trajectoryBuilder(lineToLeftDrop.end())
                .back(7)
        ...
        Trajectory backOutBlockPile = drive.trajectoryBuilder(goInBlockPile.end())
                .back(11)
                .build();
        Trajectory linetoexit = drive.trajectoryBuilder(goInBlockPile2.end())
                //   .splineTo(new Vector2d(-16 , -40), Math.toRadians(90))
        ...
        Trajectory moveOver = drive.trajectoryBuilder(new Pose2d(-10,44,Math.toRadians(80)))
                .strafeLeft(3)
                .build();
        Trajectory goInDepot2 = drive.trajectoryBuilder(new Pose2d(-15,45,Math.toRadians(0)))
                .lineToLinearHeading(new Pose2d(45,45, Math.toRadians(-8)))
                .addDisplacementMarker(0,() -> {
                    Claw.setPosition(grabberClose);
    ...
    //    drive.turn(Math.toRadians(-90));
     ...
     //   drive.followTrajectory(straferight);
        if (FinalDecision == "Left"){
            ...
            drive.followTrajectory(lineToLeftDrop);
      ...
      //  drive.followTrajectory(forward2);
        ...
        Arm.setPower(-0.25);
        if (FinalDecision == "Left"){
            drive.followTrajectory(goInDepotafterbackingup);
        } else {
        ...
        drive.followTrajectory(goInBlockPile2);
        //drive.followTrajectory(goInBlockPile3);
        sleep(300);
        Claw.setPosition(grabberClose);
        ...
        telemetry.addData("Fart1", currentX);
        telemetry.addData("Fart2", currentY);
        telemetry.update();
        drive.turn(Math.toRadians(90));
        Pose2d WallTargetPose = new Pose2d(currentX, currentY,Math.toRadians(90));
        drive.setPoseEstimate(WallTargetPose);
        Trajectory dumpBlock = drive.trajectoryBuilder(WallTargetPose)
                .lineToLinearHeading(new Pose2d(-11,47, Math.toRadians(85)))
                .addDisplacementMarker(0,() -> {
                    Wrist.setPosition(WristDown);
                })
        ...
        while (opModeIsActive()){
            ...
            if (targetVisible) {
                ...
                if (trueTracking){
                    ...
                    currentX = (translation.get(0) / mmPerInch) - 11l;
                    currentY = (translation.get(1) / mmPerInch) - 10;
                    break;
                }
