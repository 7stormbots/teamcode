...
public class ShippingElementDetectorBlueDepot extends OpenCvPipeline {
    ...
    public ShippingElementDetectorBlueDepot() {
...
*/
        ...
        Mat matRight2 = workingMatrix2.submat(260, 320, 124, 184);
        Mat matCenter2 = workingMatrix2.submat(260, 320, 300, 360);

        Imgproc.rectangle(workingMatrix2, new Rect(154, 290, 60, 60), new Scalar(255, 255, 255));
        Imgproc.rectangle(workingMatrix2, new Rect(330, 290, 60, 60), new Scalar(0, 0, 255));
// COLUMN = X  ROW = Y
        ...
        if (Righttotal < 400000) {
            position = "Center";
        }   else if (Centertotal < 400000) {
            position = "Right";
