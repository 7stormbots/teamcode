...
@Autonomous(name = "RedWarehousev2 (Now with intake.)", group = "")
@Disabled
public class RedWarehousev2 extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        Trajectory straferight = drive.trajectoryBuilder(startPose)
                ...
                .strafeRight(4)
                .build();
        Trajectory lineToHub = drive.trajectoryBuilder(straferight.end())
                //   .splineTo(new Vector2d(-16 , -40), Math.toRadians(90))

                .lineToLinearHeading(new Pose2d(-9,-58,Math.toRadians(-90)))
                ...
                .build();
        Trajectory lineToHub2 = drive.trajectoryBuilder(straferight.end())
                //   .splineTo(new Vector2d(-16 , -40), Math.toRadians(90))
        ...
        Trajectory goInDepotafterbackingup = drive.trajectoryBuilder((new Pose2d(-5,-32,Math.toRadians(0))))
                .lineToLinearHeading(new Pose2d(50,-42,Math.toRadians(4)))
                .addDisplacementMarker(43,() -> {
                    Arm.setTargetPosition(0);
                    Arm.setPower(0.5);
        ...
        Trajectory goInDepot2 = drive.trajectoryBuilder(new Pose2d(-18,-45,Math.toRadians(0)))
                .lineToLinearHeading(new Pose2d(50,-37, Math.toRadians(5)))
                .addDisplacementMarker(0,() -> {
                    Claw.setPosition(grabberClose);
     ...
     //   drive.followTrajectory(straferight);
      ...
      //  drive.followTrajectory(forward2);
        ...
        Trajectory dumpBlock = drive.trajectoryBuilder(new Pose2d(currentX, currentY, Math.toRadians(-90)))
                .lineToLinearHeading(new Pose2d(-13,-45, Math.toRadians(-96)))
                .addDisplacementMarker(0,() -> {
                    Wrist.setPosition(WristDown);
                })
