...
public class ShippingElementDetectorRedCarousel extends OpenCvPipeline {
    ...
    public ShippingElementDetectorRedCarousel() {
...
*/
        Mat matRight2 = workingMatrix2.submat(560, 620, 240, 300);
        Mat matCenter2 = workingMatrix2.submat(320, 380, 240, 300);
        Mat matLeft2 = workingMatrix2.submat(70, 130, 240, 300);

        Imgproc.rectangle(workingMatrix2, new Rect(270, 590, 60, 60), new Scalar(0, 255, 0));
        Imgproc.rectangle(workingMatrix2, new Rect(270, 350, 60, 60), new Scalar(255, 255, 255));
        Imgproc.rectangle(workingMatrix2, new Rect(270, 100, 60, 60), new Scalar(0, 0, 255));
// COLUMN = X  ROW = Y
