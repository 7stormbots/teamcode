...
@Autonomous(name = "BlueCarousel (Inspire alliance bot friendly!)", group = "")
@Disabled
public class BlueCarousel extends LinearOpMode {
    ...
    public double grabberHalfOpen = 0.6;
    ...
    public void runOpMode(){
        ...
        Trajectory rightDepotTurn = drive.trajectoryBuilder(backhub.end())
                ...
                .build();
        Trajectory getLeftDuck = drive.trajectoryBuilder(backhub.end().plus(new Pose2d(0,0,Math.toRadians(53))))
                .forward(14)
                .build();
        Trajectory dumpLeftDuck = drive.trajectoryBuilder(getLeftDuck.end())
                .lineToLinearHeading(new Pose2d(-3,46, Math.toRadians(75)))
                .build();
        Trajectory getCenterDuck = drive.trajectoryBuilder(backhub.end().plus(new Pose2d(0,0,Math.toRadians(57))))
                .forward(21)
                .build();
        Trajectory dumpCenterDuck = drive.trajectoryBuilder(getCenterDuck.end())
                .lineToLinearHeading(new Pose2d(-2,46, Math.toRadians(78)))
                .build();
        Trajectory getRightDuck = drive.trajectoryBuilder(backhub.end().plus(new Pose2d(0,0,Math.toRadians(53))))
                .forward(15)
                .build();
        Trajectory dumpRightDuck = drive.trajectoryBuilder(getRightDuck.end())
                .lineToLinearHeading(new Pose2d(-2,46, Math.toRadians(78)))
                .build();
        Trajectory goInDepot = drive.trajectoryBuilder(dumpCenterDuck.end().plus(new Pose2d(0,0,Math.toRadians(-78))))
                .lineToLinearHeading(new Pose2d(40,48, Math.toRadians(0)))
                ...
                .build();
        Trajectory goInBlockPile = drive.trajectoryBuilder(goInDepot.end().plus(new Pose2d(0,0,Math.toRadians(32))))
                .forward(11)
                .build();
     ...
     //   drive.followTrajectory(straferight);
      ...
      //  drive.followTrajectory(forward2);
        ...
        if (FinalDecision == "Right"){
            ...
            drive.followTrajectory(getRightDuck);
            Claw.setPosition(grabberClose);
            sleep(1000);
            Arm.setTargetPosition(armTopBehind);
            Arm.setPower(1);
            drive.followTrajectory(dumpRightDuck);
            sleep(200);
            Claw.setPosition(grabberOpen);
            sleep(400);
        ...
        Trajectory dumpBlock = drive.trajectoryBuilder(new Pose2d(currentX,currentY,Math.toRadians(0)))
                .lineToLinearHeading(new Pose2d(-3,46, Math.toRadians(70)))
                .build();
